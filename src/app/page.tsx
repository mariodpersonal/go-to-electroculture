...
const categoryImages: Record<string, string> = {
  antennas: "/images/single-multi-crystal-antennas.png",
  pyramids: "/images/quartz-spiraled-pyramid.png",
            ...
            return (
              ...
              >
                <Image
                  ...
                  alt={info.label}
                  fill
                  className={`object-cover transition-transform duration-500 group-hover:scale-105 ${cat === "antennas" ? "object-top" : "object-center"}`}
                  unoptimized
                />
