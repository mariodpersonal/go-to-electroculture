...
export const products: Product[] = [
  ...
  // ── Pyramids ──────────────────────────────────────────
  {
    ...
    description: "A solid copper pyramid built for countertops, windowsills, and indoor spaces. Place it near potted herbs, on a kitchen counter over produce, or anywhere you want copper energy without going outdoors. Clean lines, solid construction. Two sizes — pick what fits your space.",
    features: ["Available in 12\" x 12\" or 16\" x 16\"", "Tabletop-friendly design", "Indoor use — kitchen, windowsill, shelf", "Solid copper — no plating"],
    price: 75,
    category: "pyramids",
    categoryLabel: "Pyramids",
    dimensions: "12\" x 12\" or 16\" x 16\"",
    weight: 1.8,
    image: "/images/counter-pyramid.png",
    images: ["/images/counter-pyramid.png"],
    stock: 7,
    inStock: true,
    variants: [
      { id: "counter-12x12", label: "12\" x 12\"", price: 75 },
      { id: "counter-16x16", label: "16\" x 16\"", price: 150 },
    ],
  },
  {
    id: "pyr-large-quartz",
  ...
  {
    id: "pyr-7-chakra-large",
    slug: "7-stone-chakra-large-pyramid",
    name: "7 Stone Chakra Large Pyramid",
    tagline: "Seven stones. Full pyramid power.",
    description: "A large copper pyramid with seven genuine chakra stones set at key points throughout the structure. Each stone corresponds to an energy center — root to crown — while the pyramid shape concentrates and focuses that energy downward into your space. This is the most intentional build in the lineup. Hours of handwork. Built to be a centerpiece.",
    features: ["7 genuine chakra stones", "Large copper pyramid construction", "Full spectrum energy alignment", "Handcrafted — hours of work in every joint"],
    price: 600,
    category: "pyramids",
    categoryLabel: "Pyramids",
    weight: 4.0,
    image: "/images/7-stone-chakra-large-pyramid.png",
    images: ["/images/7-stone-chakra-large-pyramid.png"],
    stock: 2,
    inStock: true,
  },
